...
import { FaSortUp } from 'react-icons/fa'; // Chỉ import FaSortUp
...
const WorkScheduleManagement = () => {
  const fakeTasks = [
    ...
    { name: 'Kiểm tra tiến độ dự án', status: 'completed', project: 'Dự án C', deadline: '2024-03-22', completed: true },
        ...
        <Modal.Body>
          {selectedTask && (
            <div>
              ...
              <p><strong>Trạng thái:</strong> {selectedTask.status === 'pending' ? 'Chờ xử lý' : 
